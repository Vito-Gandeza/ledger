...
- **Payment timeline.** A month calendar with per-loan colour dots and per-day totals.
- **Safe to spend.** Allowance left after every envelope is topped up for the next two weeks.
